...
import br.edu.ufape.backend.substituicao.facade.SubstituicaoFacade;
...
public class SubstituicaoComprovanteController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<SubstituicaoComprovanteDTO> atualizarMetadados(
            @PathVariable Long id,
            @RequestBody SubstituicaoComprovanteDTO dados) {
        return ResponseEntity.ok(facade.atualizarMetadados(id, dados));
    }
}
